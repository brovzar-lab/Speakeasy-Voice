...
struct DashboardHeroCard: View {
    ...
    private var styledHeadline: AttributedString {
        ...
        switch headline {
        case .calculatingProgress:
            highlightedValue = String(localized: "Speakeasy-Voice progress")
        ...
        case .savedTime(let value):
            ...
            text = AttributedString(localized: "You have saved \(highlightedValue) with Speakeasy-Voice")
        }
    ...
    private var lockedInsightsPrompt: some View {
        HStack(alignment: .center, spacing: 14) {
            ...
            Text("Continue using Speakeasy-Voice to unlock stats and insights.")

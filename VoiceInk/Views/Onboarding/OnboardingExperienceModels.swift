...
enum OnboardingExperienceCatalog {
    static let steps: [OnboardingExperienceStep] = [
        ...
        OnboardingExperienceStep(
            ...
            subtitle: "Turn your spoken note into a clean email draft with Speakeasy-Voice.",
            sampleLabel: "Sample text",
        ...
        OnboardingExperienceStep(
            ...
            title: "Try Rewrite",
            subtitle: "Select the text on the screen, tell Speakeasy-Voice the changes you want, and Speakeasy-Voice will rewrite the text for you.",
            sampleLabel: "Sample text",
        ...
        OnboardingExperienceStep(
            ...
            subtitle: "Ask quick questions and Speakeasy-Voice will serve you the answers.",
